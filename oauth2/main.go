...
func callbackHandler(w http.ResponseWriter, r *http.Request) {
	...
	// save the token and the refresh token
	...
	resp, err := client.Get("https://dev-70309037.okta.com/")
	if err != nil {
		log.Fatal(err)
	} else {
...
func main() {
	...
	conf = &oauth2.Config{
		ClientID:     "0oa2vd9f44ZIrAZl65d7",
		ClientSecret: "lQC594h5wLpTe2XHKQqUkclywKVJI3O4ee0abllQ",
		Scopes:       []string{"openid profile email groups", "offline_access"},
		Endpoint: oauth2.Endpoint{
			AuthURL:  "dev-70309037.okta.com/oauth2/v1/authorize",
			TokenURL: "https://dev-70309037.okta.com/oauth2/v1/token",
		},
		// my own callback URL
